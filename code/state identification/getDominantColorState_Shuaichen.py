...
def main():
    ...
    # read contiguous US bounds results from pickle file
    usBoundResultName = r'C:\Users\jiali\Desktop\shuaichen\USBoundResults.pickle'
    ...
    for usBoundResult in USBoundResults:
        ...
        if img1Name == 'ChoImg5-20.png':
            continue
        if beforeOrAfter == 0:
            if img1Name == 'ChoImg6-42.png':
                beforeOrAfter = 1
            continue
        ...
        if usBoundArea > img1Area / 4: # usBound is correct
            ...
            xMaxImg, yMaxImg = maxCoordImg[0][0],maxCoordImg[0][1]
            xMinImg, yMinImg = minCoordImg[0][0], minCoordImg[0][1]
            deltaImgX = xMaxImg - xMinImg
            deltaImgY = yMaxImg - yMinImg

            xofPointWithMinY = getXofPointWithMinY(usBound,yMinImg)
            if xofPointWithMinY < xMinImg + deltaImgX/3 or xofPointWithMinY > xMaxImg - deltaImgX/3: # conic CRS
            ...
            fig = plt.figure()
            ax = plt.gca()
            ax.scatter(xMinImg, yMinImg, color='blue', marker='o', alpha=0.8)
            ax.scatter(xMaxImg, yMaxImg, color='blue', marker='o', alpha=0.8)
            ...
            for state in list(short_state_names.values()):
                ...
                xImgState = xMinImg + (xCentroidGeo - x1) / deltaGeoX * deltaImgX
                yImgState = yMinImg + (y2 - yCentroidGeo ) / deltaGeoY * deltaImgY
            ...
            if beforeOrAfter == 0:
                if img1Name == 'ChoImg6-42.png':
                    beforeOrAfter = 1
                continue
            # if img1Name == '1_RR-cmQrDtwBSJKXIdJpshQ.png':
            #     beforeOrAfter = 1
            #     continue
        ...
        with open(r'C:\Users\jiali\Desktop\shuaichen\centroidImgCoordList_'+img1Name+'.pickle', 'wb') as f:
            pickle.dump(centroidStateCoordList,f)
