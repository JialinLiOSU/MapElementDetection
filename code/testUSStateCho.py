...
def main():
    ...
    for imgName in testImageDir:
        ...
        for bound in textBboxes:
            ...
            if titleBbox.intersects(textPolygon) and bound[2]>pow(10,-10) and (not isValueText(bound[1])):
    ...
    print('test')
    with open(r'C:\Users\jiali\Desktop\MapElementDetection\code\postProcessingDetection\titleResultsUSCho.pickle', 'wb') as f:
	    pickle.dump(titleResults,f)
    
    file = open(r'C:\Users\jiali\Desktop\MapElementDetection\code\postProcessingDetection\titleResultsUSCho.txt','a')
