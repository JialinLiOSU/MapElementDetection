...
def main():
    # read legend postprocessing results from pickle file
    legendResultName = r'C:\Users\jiali\Desktop\MapElementDetection\code\postProcessingDetection\legendResults.pickle'
    with open(legendResultName, 'rb') as fDetectResults:
